...
varE<-2          # *** This is starting H=0.33,  H=0.1 or H=0.5  ## Dry matter vs Wet biomass

nDH0<-2           # Number of GPs per SP generated in the founder population to creat the inital GP0_DH

```

## Number of individuals to Phenotype, Reps and cycles
```{r Phenotyping, Reps, Cycles}
nPheno<-400  ## ?? Use shiny to render the number of crosses
### nPheno<-1000
