...
#####Starting from here:
rm=list(ls())
setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/varE1.22_Ne60/")
SchemePlot<-"varE1.22_Ne60_nDH25" ### !!! Need change everytime


rm=list(ls())
setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/varE1.22_Ne600/")
SchemePlot<-"varE1.22_Ne600_nDH25" ### !!! Need change everytime


rm=list(ls())
setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/varE2_Ne60/")
SchemePlot<-"varE2_Ne60_nDH25"
 
 
rm=list(ls())
setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/varE2_Ne600/")
SchemePlot<-"varE2_Ne600_nDH25"


rm=list(ls())
setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/varE5.67_Ne60/")
SchemePlot<-"varE5.67_Ne60_nDH25" ### !!! Need change everytime
...
# rm=list(ls())
# setwd("/Users/maohuang/Desktop/Kelp/Simulation_Study/SimulationKelp/Run_Function/Different_varE_nDH/nDH25/")
