...
```{r}
## Select Random
Rand<-function (Population,n_gp){
  females<-selectInd(pop=Population,gender="F",nInd=n_gp,trait=1,use="rand",simParam=SP)
  males<-selectInd(pop=Population,gender="M",nInd=n_gp,trait=1,use="rand",simParam=SP)	
...
## Random Select amongst Spj
Spj_s<-selectInd(Sporo[[j]],nInd=100,trait=1,use="rand",simParam=SP)					
Sporo_s<-c(Sporo_s,Spj_s)

            ### !!! OR			 
            # Spj_s<-selectInd(Sporo[[j]],nInd=100,trait=1,selectTop=TRUE,use="pheno",simParam=SP)	
            ####		
...
## Year 2, exactly the same scheme as in Year 1
            ...
            Sporo_js<-selectInd(Sporo[[j]],nInd=100,trait=1,use="rand",simParam=SP)  
